...
chcp 65001 >nul
title [Dev] Bootstrapper - Website QuanLyThuVien
color 0A

echo ================================================================
echo       HỆ THỐNG MICROSERVICES - WEBSITE QuanLyThuVien
echo ================================================================
echo.
...
:: 2. Chạy QuanLyThuVien
echo [2/3] Starting QuanLyThuVien Service...
if exist "QuanLyThuVien" (
    start "QuanLyThuVien" cmd /k "color 0E & title [Service] QuanLyThuVien & cd QuanLyThuVien && dotnet run"
    echo   -^> OK! Da mo cua so QuanLyThuVien.
) else (
    echo   -^> LỖI: Khong tim thay thu muc QuanLyThuVien!
)
timeout /t 3 >nul
echo.
